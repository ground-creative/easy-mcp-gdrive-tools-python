...
from app.tools.edit_document import gdrive_edit_document_tool
...
def test_get_contents_tool(auth_setup, create_folder_setup, create_doc_setup):
    ...
    response = gdrive_get_file_contents_tool(file_id=test_doc_id)
...
def test_edit_tool(auth_setup, create_folder_setup, create_doc_setup):
    ...
    # Edit the document
    edit_response = gdrive_edit_document_tool(
